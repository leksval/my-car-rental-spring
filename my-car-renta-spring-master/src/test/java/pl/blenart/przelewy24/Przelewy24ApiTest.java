...
public class Przelewy24ApiTest {
    ...
    public void itPerformHttpRegisterRequest() {
        ...
        api.registerPayment(new RegisterPaymentData("session_id", 12300, "blenart@uek.krakow.pl", "", "", "","","",""));
        Request r = httpClient.lastRequest;
    ...
    public void itFillApiResponseWithArguments() {
        ...
        ApiResponse response = api.registerPayment(new RegisterPaymentData("sesion_id", 12300, "blenart@uek.krakow.pl", "", "", "", "","",""));
